...
Ray PhysicallyBasedCamera::GetRay(int _x, int _y, int _w, int _h, std::default_random_engine & _rnd, float& weight) const
{
	...
	Vector3 dir = alpha * Vector3(1, 0, 0) + beta * Vector3(0, 1, 0) + Vector3(0, 0, -1);
	dir.Normalize();
